...
#################################################################
####  DEVOLEMOS LA ASISTENCIA A UN PARTIDO                   ####
#################################################################
def devolverAsistenciaPartido(soup):
    try:
        ...
        try:
            int(str(soup.find("strong", text="Attendance: ").next_sibling.strip().encode('utf-8')).replace(",", ""))
        except AttributeError as error:
            return 15000;
    except:
        return 15000;
...
############################################################################
####  RECOGEMOS EL TANTEO POR CUARTDOS DEL PARTIDO DE CADA EQUIPO       ####
############################################################################
...
def devolverCuartos(equipo, numeroCuartos):
    primerCuarto = segundoCuarto = tercerCuarto = cuartoCuarto = 0
    primerOver = segundoOver = tercerOver = cuartoOver = quintoOver = sextoOver = 0
...
############################################################
####  DEVOLVEMOS LA HORA Y LA UBICACION DEL PARTIDO     ####
############################################################
...
#############################################################################
####  DEVOLVEMOS SI UN JUGADOR NO HAY JUGADO O SI TENEMOS TIEMPOS EXTRA  ####
#############################################################################
...
##################################################################
####  FOMRATEAMOS UN VALOR CORRECTAMENTE                      ####
##################################################################
...
#################################################################
####  DEVOLVEMOS UN 0 SI EL DATO VIENE VACIO                 ####
#################################################################
...
############################################################################
####  DEVOLVEMOS LAS ESTADISTICAS NORMALES DE LOS JUGADORES Y EQUIPOS   ####
############################################################################
def devolverStadisticasNormalesJugadores(equipo, pagina):
    equipo.jugadores = []
    ##  RECOGEMOS LOS JUGADORES DEPENDIENDO DEL EQUIPO QUE ESTAMOS
            ...
            for campo in campos:
                ...
                for resultado in campo.findAll('td'):
                    ...
                    if str(campo.find('th').text) == 'Team Totals':
                        ...
                        if i == 1: equipo.estadisticaNormal.tirosCampoMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 2: equipo.estadisticaNormal.tirosCampoIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 3: equipo.estadisticaNormal.tirosCampoPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 4: equipo.estadisticaNormal.triplesMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 5: equipo.estadisticaNormal.triplesIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 6: equipo.estadisticaNormal.triplesPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 7: equipo.estadisticaNormal.tirosLibresMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 8: equipo.estadisticaNormal.tirosLibresIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 9: equipo.estadisticaNormal.tirosLibresPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 10: equipo.estadisticaNormal.reboteOfensivo = int(0 if resultado.text == '' else resultado.text)
                        if i == 11: equipo.estadisticaNormal.reboteDefensivo = int(0 if resultado.text == '' else resultado.text)
                        if i == 12: equipo.estadisticaNormal.totalRebotes = int(0 if resultado.text == '' else resultado.text)
                        if i == 13: equipo.estadisticaNormal.asistencias = int(0 if resultado.text == '' else resultado.text)
                        if i == 14: equipo.estadisticaNormal.robos = int(0 if resultado.text == '' else resultado.text)
                        if i == 15: equipo.estadisticaNormal.tapones = int(0 if resultado.text == '' else resultado.text)
                        if i == 16: equipo.estadisticaNormal.perdidas = int(0 if resultado.text == '' else resultado.text)
                        if i == 17: equipo.estadisticaNormal.faltasPersonales = int(0 if resultado.text == '' else resultado.text)
                        if i == 18: equipo.estadisticaNormal.puntos = int(0 if resultado.text == '' else resultado.text)
                        ...
                        if i == 1: jugando.boxscore.tirosCampoMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 2: jugando.boxscore.tirosCampoIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 3: jugando.boxscore.tirosCampoPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 4: jugando.boxscore.triplesMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 5: jugando.boxscore.triplesIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 6: jugando.boxscore.triplesPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 7: jugando.boxscore.tirosLibresMetidos = int(0 if resultado.text == '' else resultado.text)
                        if i == 8: jugando.boxscore.tirosLibresIntentados = int(0 if resultado.text == '' else resultado.text)
                        if i == 9: jugando.boxscore.tirosLibresPorcentaje = float(0 if resultado.text == '' else resultado.text)
                        if i == 10: jugando.boxscore.reboteOfensivo = int(0 if resultado.text == '' else resultado.text)
                        if i == 11: jugando.boxscore.reboteDefensivo = int(0 if resultado.text == '' else resultado.text)
                        if i == 12: jugando.boxscore.totalRebotes = int(0 if resultado.text == '' else resultado.text)
                        if i == 13: jugando.boxscore.asistencias = int(0 if resultado.text == '' else resultado.text)
                        if i == 14: jugando.boxscore.robos = int(0 if resultado.text == '' else resultado.text)
                        if i == 15: jugando.boxscore.tapones = int(0 if resultado.text == '' else resultado.text)
                        if i == 16: jugando.boxscore.perdidas = int(0 if resultado.text == '' else resultado.text)
                        if i == 17: jugando.boxscore.faltasPersonales = int(0 if resultado.text == '' else resultado.text)
                        if i == 18: jugando.boxscore.puntos = int(0 if resultado.text == '' else resultado.text)
                        if i == 19:
                            jugando.boxscore.masMenos = int(0 if resultado.text == '' else resultado.text)
...
###################################################################################
####  DEVOLVEMOS LAS ESTADISTICAS AVANZADAS DE JUGADORES Y EQUIPOS             ####
###################################################################################
        ...
        for campo in campos:
            ...
            for resultado in campo.findAll('td'):
                ...
                if str(campo.find('th').text) == 'Team Totals':
                    ...
                    if i == 1: equipo.estadisticaAvanzada.trueShootPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 2: equipo.estadisticaAvanzada.effectiveGoalPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 3: equipo.estadisticaAvanzada.threePointRate = float(0 if resultado.text == '' else resultado.text)
                    if i == 4: equipo.estadisticaAvanzada.freeThrowRate = float(0 if resultado.text == '' else resultado.text)
                    if i == 5: equipo.estadisticaAvanzada.offensiveReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 6: equipo.estadisticaAvanzada.defensiveReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 7: equipo.estadisticaAvanzada.totalReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 8: equipo.estadisticaAvanzada.assistPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 9: equipo.estadisticaAvanzada.stealPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 10: equipo.estadisticaAvanzada.blockPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 11: equipo.estadisticaAvanzada.turnoverPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 12: equipo.estadisticaAvanzada.usagePercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 13: equipo.estadisticaAvanzada.offensiveRating = float(0 if resultado.text == '' else resultado.text)
                    if i == 14: equipo.estadisticaAvanzada.defensiveRating = float(0 if resultado.text == '' else resultado.text)
                else:  ## ESTADISTICAS DEL LOS JUGADORES QUE HAN JUGADO ALGUN MINUTO
                    ...
                    if i == 1: equipo.jugadores[posicion].estadisticaAvanzada.trueShootPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 2: equipo.jugadores[posicion].estadisticaAvanzada.effectiveGoalPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 3: equipo.jugadores[posicion].estadisticaAvanzada.threePointRate = float(0 if resultado.text == '' else resultado.text)
                    if i == 4: equipo.jugadores[posicion].estadisticaAvanzada.freeThrowRate = float(0 if resultado.text == '' else resultado.text)
                    if i == 5: equipo.jugadores[posicion].estadisticaAvanzada.offensiveReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 6: equipo.jugadores[posicion].estadisticaAvanzada.defensiveReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 7: equipo.jugadores[posicion].estadisticaAvanzada.totalReboundPer = float(0 if resultado.text == '' else resultado.text)
                    if i == 8: equipo.jugadores[posicion].estadisticaAvanzada.assistPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 9: equipo.jugadores[posicion].estadisticaAvanzada.stealPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 10: equipo.jugadores[posicion].estadisticaAvanzada.blockPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 11: equipo.jugadores[posicion].estadisticaAvanzada.turnoverPercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 12: equipo.jugadores[posicion].estadisticaAvanzada.usagePercentage = float(0 if resultado.text == '' else resultado.text)
                    if i == 13: equipo.jugadores[posicion].estadisticaAvanzada.offensiveRating = float(0 if resultado.text == '' else resultado.text)
                    if i == 14: equipo.jugadores[posicion].estadisticaAvanzada.defensiveRating = float(0 if resultado.text == '' else resultado.text)
                i += 1
    return equipo
...
##################################################################
####  DEVOLVEMOS LA PAGINA DE TIROS DE UN EQUIPO              ####
##################################################################
def devolverPosicionTirosJugadores(equipo, pagina):
    for i in range(len(equipo.jugadores)):
        ...
        if 'Nene' == nombre and len(nombreLen) == 1:
...
def completarCartaTiro(jugadores):
    for jugador in jugadores:
        for tiro in jugador.listaTiros:
            
            # Tanteo equipo - Tanteo rival
            tanteo = tiro.tanteo.split('-')
            tanteoEquipo = tanteo[0]
            tanteoRival = tanteo[1]
            
            tiro.tanteoEquipo=tanteoEquipo
            tiro.tanteoRival=tanteoRival
            
            if int(tanteoEquipo) == int(tanteoRival):
                tiro.meterSituacionDespues("EMPATE")
            elif int(tanteoEquipo) < int(tanteoRival):
                tiro.meterSituacionDespues("PERDIENDO")
            elif int(tanteoEquipo) > int(tanteoRival):
                tiro.meterSituacionDespues("GANANDO")
                
            if tiro.dentro:
                tanteoEquipo = int(tanteoEquipo)-int(tiro.tipo)
                
            if int(tanteoEquipo) == int(tanteoRival):
                tiro.meterSituacionAntes("EMPATE")
            elif int(tanteoEquipo) < int(tanteoRival):
                tiro.meterSituacionAntes("PERDIENDO")
            elif int(tanteoEquipo) > int(tanteoRival):
...
def devolverPlayByPlayJugadores(partido, pagina, url, numero):
    ...
    global segundoCuartoCreado
    global tercerCuartoCreado
    global cuartoCuartoCreado
    global primerOvertimeCreado
    global segundoOvertimeCreado
    global tercerOvertimeCreado
    global cuartoOvertimeCreado
    global quintoOvertimeCreado
    global sextoOvertimeCreado
    segundoCuartoCreado = False
    tercerCuartoCreado = False
    cuartoCuartoCreado = False
    primerOvertimeCreado = False
    segundoOvertimeCreado = False
    tercerOvertimeCreado = False
    cuartoOvertimeCreado = False
    quintoOvertimeCreado = False
    sextoOvertimeCreado = False
...
# ##############  IMPRIMIR DATOS                                      #########
# #############################################################################
#     t = PrettyTable(['Nombre', 'Apellido',
#                      'FG', 'FGA', 'FG%',
#                      '3P', '3PA', '3P%',
#                      'FT', 'FTA', 'FT%', '1FT', '1FT%', '2FT', '2FT%', '3FT', '3FT%',
#                      'DRB', 'ORF', 'TRB', 'ASIS', 'TURN', 'STEAL',
#                      'OFF', 'DFF', 'SHOF', 'TECF', 'TOF',
#                      'F.Pro.De', 'F.Pro.Tiro', 'F.Pro.Ata', 'TOTAL PROV',
#                      'BLO', 'BLORECI', 'BLORECI3',
#                      'Ti.OK', 'Ti.X', 'Band.X', 'Band.OK', 'Dunk.OK', 'Dunk.X', 'Hook.OK', 'Hook.X',
#                      'PUNTOS',
#                      'PASOS', 'LOST', 'BANDA', 'GOAL', 'MAL', 'PISAR'
#                      ])
#     t.align['Nombre'] = "l"
#     t.align['Apellido'] = "l"
#     t.align['FG%'] = "l"
...
#     t.align['3FT%'] = "l"
#     print '************************* EQUIPO LOCAL **************************************'
#     for i in partido.equipoLocal.jugadores:
#         t.add_row([i.nombre, i.apellido,
#                    i.totalPartido.tirosCampoMetidos, i.totalPartido.tirosCampoIntentados,
#                    i.totalPartido.tirosCampoPorcentaje,
#                    # T IROS DE CAMPO
#                    i.totalPartido.triplesMetidos, i.totalPartido.triplesIntentados,
#                    i.totalPartido.triplesPorcentaje,  # TIROS DE 3
#                    i.totalPartido.tirosLibresMetidos, i.totalPartido.tirosLibresIntentados,
#                    i.totalPartido.tirosLibresPorcentaje,
#                    # TIROS LIBRES
#                    str(i.totalPartido.primerTiroLibreDentro) + "/" + str(i.totalPartido.primerTiroLibreTotal),
#                    i.totalPartido.primerTiroLibrePorcentaje,
#                    str(i.totalPartido.segundoTiroLibreDentro) + "/" + str(i.totalPartido.segundoTiroLibreTotal),
#                    i.totalPartido.segundoTiroLibrePorcentaje,
#                    str(i.totalPartido.tercerTiroLibreDentro) + "/" + str(i.totalPartido.tercerTiroLibreTotal),
#                    i.totalPartido.tercerTiroLibrePorcentaje,
#                    i.totalPartido.reboteDefensivo, i.totalPartido.reboteOfensivo, i.totalPartido.totalRebotes,
#                    # REBOTES
#                    i.totalPartido.asistencias, i.totalPartido.perdidas, i.totalPartido.robos,
#                    # ASISTENCIAS , PERDIDAS ROBOS
#                    i.totalPartido.faltaPersonalAtaque, i.totalPartido.faltaPersonalDefensa,
#                    i.totalPartido.faltaPersonalTiro, i.totalPartido.faltaTecnica, i.totalPartido.faltasPersonales,
#                    # FALTAS PERSONALES
#                    i.totalPartido.faltaPersonalProvocadaEnDefensa, i.totalPartido.faltaPersonalProvocadaEnTiro,
#                    i.totalPartido.faltaPersonalProvocadaEnAtaque, i.totalPartido.faltasPersonalesProvocadas,
#                    # FALTAS PERSONALES PROVOCADAS
#                    i.totalPartido.tapones, i.totalPartido.taponRecibido, i.totalPartido.taponRecibidoTriple,  # TAPONES
#                    i.totalPartido.suspension, i.totalPartido.suspensionFallado,  # TIPO DE TIRO - TIRO
#                    i.totalPartido.bandeja, i.totalPartido.bandejaFallada,  # TIPO DE TIRO - BANDEJA
#                    i.totalPartido.mate, i.totalPartido.mateFallado,  # TIPO DE TIRO - MATE
#                    i.totalPartido.gancho, i.totalPartido.ganchoFallado,  # TIPO DE TIRO - GANCHO
#                    i.totalPartido.puntos,  # PUNTOS
#                    i.totalPartido.perdidaPasos, i.totalPartido.perdidaBalonPerdido, i.totalPartido.perdidaFueraBanda,
#                    i.totalPartido.perdidaGoaltending, i.totalPartido.perdidaMalPase, i.totalPartido.perdidaPisarFuera
#                    # TIPO PERDIA
#                    ])
#     # print t
#     archivoBox = funciones.crearArchivoBoxscorePartido(partido,url,numero)
#     funciones.escribirEnDocumento(archivoBox,'Año: '+partido.year)
#     funciones.escribirEnDocumento(archivoBox,'Mes: '+partido.mes)
#     funciones.escribirEnDocumento(archivoBox,'Día: '+partido.dia)
#     funciones.escribirEnDocumento(archivoBox,partido.equipoVisitante.nombre + " "+str(partido.equipoVisitante.tanteo) + " - " + str(partido.equipoLocal.tanteo) + " " +partido.equipoLocal.nombre)
#     funciones.escribirEnDocumento(archivoBox,"\n ESTADISTICAS DEL EQUIPO LOCAL")
#     funciones.escribirEnDocumento(archivoBox,t)
#     d = PrettyTable(['Nombre', 'Apellido',
#                      'FG', 'FGA', 'FG%',
#                      '3P', '3PA', '3P%',
#                      'FT', 'FTA', 'FT%', '1FT', '1FT%', '2FT', '2FT%', '3FT', '3FT%',
#                      'DRB', 'ORF', 'TRB', 'ASIS', 'TURN', 'STEAL',
...
#     for i in partido.equipoVisitante.jugadores:
#         d.add_row([i.nombre, i.apellido,
#                    i.totalPartido.tirosCampoMetidos, i.totalPartido.tirosCampoIntentados, i.totalPartido.tirosCampoPorcentaje,
#                    # T IROS DE CAMPO
#                    i.totalPartido.triplesMetidos, i.totalPartido.triplesIntentados,
#                    i.totalPartido.triplesPorcentaje,  # TIROS DE 3
#                    i.totalPartido.tirosLibresMetidos, i.totalPartido.tirosLibresIntentados, i.totalPartido.tirosLibresPorcentaje,
#                    # TIROS LIBRES
#                    str(i.totalPartido.primerTiroLibreDentro) + "/" + str(i.totalPartido.primerTiroLibreTotal),
#                    i.totalPartido.primerTiroLibrePorcentaje,
#                    str(i.totalPartido.segundoTiroLibreDentro) + "/" + str(i.totalPartido.segundoTiroLibreTotal),
...
#     funciones.escribirEnDocumento(archivoBox, d)
    return partido
...
def actividadPartido(texto, jugadoresPartido, cuarto, otrosJugadores, primerEquipo, segundoEquipo):
    ...
    try:
        ...
        if 'Turnover by Team' not in texto:
            if 'Turnover' in texto:
                ...
                if posicion != -1:
                    ...
                    elif '(off goaltending' in texto.lower():
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaGoaltending += 1
                    elif '(back court' in texto:
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaCampoAtras += 1
                    elif '(no' in texto:
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaOtros += 1
                    elif '(3 second' in texto:
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaTresSegundos += 1
                    elif '(foul' in texto:
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaFalta += 1
                    elif '(double dribble' in texto or '(discontinued dribble':
                        jugadoresPartido[posicion].estadisticasCuarto[cuarto].perdidaDobles += 1
                    elif '(kicked ball':
        ...
        if 'foul' in texto:
            ...
            if 'Double personal foul' in texto:
                
                posicionEquipo = autorJugadaInicial(parte[4], parte[5], jugadoresPartido, otrosJugadores)
                posicionRival = autorJugadaInicial(parte[7], parte[8], otrosJugadores,jugadoresPartido)
                
                if posicionEquipo !=-1 and posicionRival !=-1:
                    jugadoresPartido[posicionEquipo].estadisticasCuarto[cuarto].faltasPersonales += 1
                    jugadoresPartido[posicionEquipo].estadisticasCuarto[cuarto].faltaPersonalDoble += 1
                    
                    otrosJugadores[posicionRival].estadisticasCuarto[cuarto].faltasPersonales += 1
                    otrosJugadores[posicionRival].estadisticasCuarto[cuarto].faltaPersonalDoble += 1
            
            elif 'Personal take ' in texto:
